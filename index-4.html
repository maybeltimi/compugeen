...
<head>
<meta charset="utf-8">
<title>Globex HTML-5 Template | Homepage 04</title>
<!-- Stylesheets -->
            ...
            <div class="auto-container">
                <div class="clearfix">
                    ...
                    <div class="top-right pull-right">
                    	<div class="text">Welcome to Globex IT HTML Template</div>
                    </div>
                </div>
            </div>
        </div>
            	...
            	<div class="nav-outer clearfix">
                    ...
                    <div class="outer-box clearfix">
                        ...
                        <div class="search-box-outer">
                            <button class="search-box-btn"><span class="fa fa-search"></span></button>
                        </div>
    ...
    <section class="banner-section-four">
        <div class="banner-carousel owl-carousel owl-theme">
            ...
            <div class="slide-item" style="background-image: url(images/main-slider/image-3.jpg)">
                <div class="auto-container">
                    <div class="content-box">
                        <span class="title">IT Business Consulting</span>
                        <h2>Our Agency Provide <br> Best IT Solutions</h2>
				...
				<div class="row clearfix">
					...
					<div class="service-block-two col-lg-4 col-md-6 col-sm-12">
						<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
							...
							<h5><a href="services-detail.html">IT Counsultancy</a></h5>
