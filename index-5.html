...
<head>
<meta charset="utf-8">
<title>Globex HTML-5 Template | Homepage 05</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
            	...
            	<div class="clearfix">
                    ...
                    <div class="top-left clearfix">
                    	<ul class="links clearfix">
                        	<li><a href="#"><span class="icon fa fa-phone"></span>Call : 1-800-555-9999</a></li>
                            <li><a href="#"><span class="icon fa fa-envelope"></span>info@globex.com</a></li>
                            <li><a href="#"><span class="icon fa fa-clock-o"></span>Open Hours 09:00 am - 06:00 pm</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="top-right clearfix">
                        ...
                        <div class="cart-box">
                        	<div class="dropdown">
                                <button class="cart-box-btn dropdown-toggle" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="fa fa-shopping-cart"></span><span class="total-cart">2</span></button>
    ...
    <section class="banner-section-two">
		<div class="pattern-layer-one" style="background-image: url(images/main-slider/pattern-4.png)"></div>
		<div class="pattern-layer-two" style="background-image: url(images/main-slider/pattern-5.png)"></div>
		<div class="pattern-layer-three" style="background-image: url(images/main-slider/pattern-6.png)"></div>
